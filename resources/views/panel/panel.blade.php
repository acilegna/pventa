      ...
      <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <a href="" class="brand-link">
            <img src="{{ asset('images/pv.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  @csrf                   
                    <label for="name" class="col-sm-12 control-label text-center">Efectivo Inicial en Caja</label>
                    ...
                    <div class="modal-footer col-sm-6">                      
                      <button type="submit" class="btn btn-primary" id="mantener" name="mantener" value="open">Dejar turno abierto y cerrar
                      </button>                     
                    </div>
                  </form>
                </div>
        ...
        <!-- Fin Contains page content -->
       
        <footer class="main-footer">
          <strong style="font-size:15px; color:#4c4c4c">Copyright &copy; 2020 <a href="#">Angelica</a>.</strong>
          Todos los derechos reservados.
          <div class="float-right d-none d-sm-inline-block">
            <b style="font-size:15px; color:#4c4c4c">Version</b> 0.1
          </div>
        </footer>
      ...
      { 
        ...
        $("#cantidad").keyup(function() 
        {
          ...
          if (cantidad>existencia)
          {
            ...
            $('#mensaje').text("No se pueden agregar más productos de este tipo, se quedarían sin existencia");
          } else{
      ...
      $(document).ready(function(){
        ...
        function fetch_customer_data(date1 = '',date2 = '',sale_by=''){
          $.ajax({
            url:"{{ route('reporte') }}",
            method:'GET',
            data:{date1:date1, date2:date2, sale_by:sale_by},
            dataType:'json',
            success:function(data){
