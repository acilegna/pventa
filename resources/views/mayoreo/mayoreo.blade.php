...
<div class="container-fluid">
  ...
  <form action="{{route('recibe')}}" method="post">
    ...
    <div class="input-group mb-3">
      ...
      <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="0" name="precioP" id="precioP" disabled="true">
    ...
    <div class="input-group mb-3">
      ...
      <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="0" name="precio">
      <div class="input-group-append  ">
        <span class="input-group-text">.00</span>
      </div>
    </div>
      ...
      <div class="input-group-prepend">
			...
			<input type="number" class="form-control" name="cantidad"aria-label="Text input with dropdown button"placeholder="0">  
		</div>

		<div class="input-group">	
			<button class="btn btn-outline-secondary" type="submit"><i class="fa fa-cube"></i> Agregar mayoreo al producto</button>				  
		</div>
  </form>
