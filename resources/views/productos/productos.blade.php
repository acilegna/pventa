        ...
        <form action="{{ url('saveProduct') }}" method="POST" id="regForm">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input id="inputCodigo" type="text"
                        class="form-control{{ $errors->has('inputCodigo') ? ' is-invalid' : '' }}" name="inputCodigo"
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control{{ $errors->has('inputDescripcion') ? ' is-invalid' : '' }}"
                        id="inputDescripcion" name="inputDescripcion" id="inputDescripcion" placeholder="Descripcion"
                ...
                <div class="form-group col-md-4">
                    ...
                    <input id="inputCategoria" type="text" class="form-control" name="inputCategoria"
                        placeholder="Categoria" required="" pattern="[A-Za-z]+">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="inputExiste" id="inputExiste" placeholder="Existencia"
            ...
            <!--BOTONES-->
            <div class="col-lg-12">
                <div class="btn-group fl-rigth"><a href="{{ route('viewFiltro') }}" class="btn btn-success"><span
                            class="fa fa-mail-reply"></span> Regresar</a> </div>

                <div class="btn-group fl-rigth"> <button class="btn btn-primary" type="submit" name="btn1" value="new"><span
                            class="fa fa-cube"></span> Guardar</button></div>
            </div>
        </form>
    </div>
@endsection
