            ...
            @csrf
                <div class="modal-body"> 
                    ...
                    <div class="modal-footer">  
                         ...
                         <button type="submit" class="btn btn-primary" id="registrar" name="registrar" value="regCaja">Registrar Dinero Inicial en Caja</button>
                        <div class="btn-group fl-rigth"><a href="{{ url('/') }}" class="btn btn-success">Cancelar</a> </div>                              
                    </div>                           
                </div>
            </form>
        </div>
