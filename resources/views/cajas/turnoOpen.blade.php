    ...
    <div class="modal-content">
      ...
      @csrf
        <div class="modal-body">
          <p>Al parecer se cerro  el programa sin haber cerrado el turno anterior, por lo que es necesario continuar dicho turno o inicar uno nuevo.</p> 
          ...
          <select class="custom-select" id="Opcioncaja" name="Opcioncaja">                  
             @foreach ($datoTurno[0] as $list)  
                <option value="{{$list->id_usu}}">{{$list->firstname}} en  {{$list->descripcion }}</option>
             @endforeach  
          </select>   
