...
<div class="container-fluid">
	...
	<div class="contenido ">
		...
		<div class="col-lg-4">
			<div class="btn-group derecha"><a href="{{route('viewcaja')}}" class="btn btn-primary"><i class="fa fa-cube"></i> Alta cajas</a> </div>	 
		</div>			
	</div>
	...
	<table class="table table-striped table-bordered">
		...
		<tfoot>
			<tr>
				<th colspan="6"><h5 class="izquierda">Registros encontrados: <span id="total_cajas"></span></h5></th>
			</tr>
  		</tfoot>
	</table>
	</div>
