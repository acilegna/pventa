  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="btn-group fl-rigth"><a href="{{ url('/') }}" class="btn btn-alert"><i class="fa fa-times"></i></a> </div>  
      ...
      <div class="modal-body">
        ...
        <label for="name" class="col-sm-12 control-label text-left"><i class="fas fa-info-circle" id="info"></i> Cierre de turno </label> 
      
           
        <p>Cuenta el dinero que hay en caja e ingrésalo para proceder con el cierre de turno.</p>        
        <div class="modal-footer">  
          <div class="form-group row">
            <label for="inputEfectivo" class="col-sm-9 col-form-label">¿Cuánto efectivo hay en Caja?</label>
            <div class="col-sm-3">
              <input type="number" class="form-control-plaintext"  id="efectivoFinal" name="efectivoFinal" placeholder="$0.00"  value=$0.00>
            </div>
          </div>
           <p id="mensaje"> </p>
          ...
          <div class="btn-group fl-rigth"><a href="" id="cancel" class="btn btn-success">Cancelar</a> </div>                      
        </div>                                    
      </div>
    </form>
...
@if ($alert!="")   
    ...
    <script>
      $(document).ready(function(){            
        ...
        $('#mensaje').text("Demasiados Intentos. El sistema te ha bloqueado, Agrega el codigo para desbloquear");
